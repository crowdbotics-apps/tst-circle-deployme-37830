...
## Project Structure
    ...
    ├── tst_circle_deployme_37830  # Django project configurations
...
1. Clone this repo and `cd tst_circle_deployme_37830`
...
2. Clone this repo and `cd tst_circle_deployme_37830`
